...
namespace Technodeviser\OneStepCheckout\Block\Checkout;

/**
 * Class LayoutProcessor
 * @package Technodeviser\OneStepCheckout\Block\Checkout
 */
class LayoutProcessor implements \Magento\Checkout\Block\Checkout\LayoutProcessorInterface
{
     ...
     * @param \Technodeviser\OneStepCheckout\Helper\Config $helperConfig
     */
    public function __construct(
        \Technodeviser\OneStepCheckout\Helper\Config $helperConfig
    ) {
    ...
    public function process($jsLayout)
    {
        if ($this->_helperConfig->isEnabledOneStep()) {
            ...
            if(isset($jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['afterMethods']['children']['giftCardAccount'])) {
                $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['afterMethods']['children']['giftCardAccount']['component'] = "Technodeviser_OneStepCheckout/js/view/payment/gift-card-account";
            }
            if(isset($jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['children']['giftCardAccount'])) {
                $jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['children']['giftCardAccount']['component'] = "Technodeviser_OneStepCheckout/js/view/summary/gift-card-account";
            }
            if(isset($jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['afterMethods']['children']['storeCredit'])) {
                $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['afterMethods']['children']['storeCredit']['component'] = "Technodeviser_OneStepCheckout/js/view/payment/customer-balance";
            }
            if(isset($jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['children']['customerbalance'])) {
                $jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['children']['customerbalance']['component'] = "Technodeviser_OneStepCheckout/js/view/summary/customer-balance";
                $jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['children']['customerbalance']['config']['template'] = "Technodeviser_OneStepCheckout/summary/customer-balance";
            }
            if(isset($jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['afterMethods']['children']['reward'])) {
                $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['afterMethods']['children']['reward']['component'] = "Technodeviser_OneStepCheckout/js/view/payment/reward";
            }
            if(isset($jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['children']['before_grandtotal']['children']['reward'])) {
                $jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['children']['before_grandtotal']['children']['reward']['component'] = "Technodeviser_OneStepCheckout/js/view/summary/reward";
            }

            /* Change template summary*/
            if(isset($jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['component'])) {
                $jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['component'] = "Technodeviser_OneStepCheckout/js/view/summary";
            }

            if(isset($jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['component'])) {
                $jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['component'] = "Technodeviser_OneStepCheckout/js/view/summary/totals";
            }

            if(isset($jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['config']['template'])) {
                $jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['totals']['config']['template'] = "Technodeviser_OneStepCheckout/summary/totals";
            }
            ...
            if(isset($jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['cart_items']['component'])) {
                $jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['cart_items']['component'] = "Technodeviser_OneStepCheckout/js/view/summary/cart-items";
            ...
            if(isset($jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['cart_items']['children']['details']['component'])) {
                $jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['cart_items']['children']['details']['component'] = 'Technodeviser_OneStepCheckout/js/view/summary/item/details';
            }
            ...
            if(isset($jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['cart_items']['children']['details']['children']['thumbnail']['component'])) {
                $jsLayout['components']['checkout']['children']['sidebar']['children']['summary']['children']['cart_items']['children']['details']['children']['thumbnail']['component'] = 'Technodeviser_OneStepCheckout/js/view/summary/item/details/thumbnail';
            }
            ...
            if ($this->_helperConfig->isEnableLoginWithAmazon()) {
                if(isset($jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']['shippingAddress']['component'])) {
                    $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']['shippingAddress']['component'] = "Technodeviser_OneStepCheckout/js/view/integration/pay-with-amazon/shipping";
                }
        ...
        if(count($childs) > 0){
            foreach($childs as $key => $child){
                if(isset($child['config']['template']) && $child['config']['template'] == 'ui/group/group' && isset($child['children'])){
                    $childs[$key]['component'] = "Technodeviser_OneStepCheckout/js/view/form/components/group";
                    if (isset($childs[$key]['children'])) {
                        $children = $childs[$key]['children'];
                        $newChildren = array();
                        foreach ($children as $item) {
                            $item['config']['component'] = "Technodeviser_OneStepCheckout/js/view/form/element/input";
                            $item['config']['elementTmpl'] = "Technodeviser_OneStepCheckout/form/element/shipping-input";
                            $newChildren[] = $item;
                        }
                ...
                if(isset($child['config']) && isset($child['config']['elementTmpl']) && $child['config']['elementTmpl'] == "ui/form/element/input"){
                    if ($key != 'postcode') {
                        $childs[$key]['config']['component'] = "Technodeviser_OneStepCheckout/js/view/form/element/input";
                    } else {
                        $childs[$key]['config']['component'] = "Technodeviser_OneStepCheckout/js/view/form/element/post-code";
                    }
                    $childs[$key]['config']['elementTmpl'] = "Technodeviser_OneStepCheckout/form/element/shipping-input";
                }
                if(isset($child['config']) && isset($child['config']['template']) && $child['config']['template'] == "ui/form/field"){
                    $childs[$key]['config']['template'] = "Technodeviser_OneStepCheckout/js/form/components/field";
                    $childs[$key]['config']['template'] = "Technodeviser_OneStepCheckout/form/field";
                }
    ...
    public function processBillingInput($payments){
        if(count($payments) > 0){
            foreach($payments as $paymentCode => $paymentComponent){
                ...
                $paymentComponent['component'] = "Technodeviser_OneStepCheckout/js/view/billing-address";
                    ...
                    foreach($childs as $key => $child){
                        if(isset($child['config']['template']) && $child['config']['template'] == 'ui/group/group' && isset($child['children'])){
                            ...
                            if (isset($childs[$key]['children'])) {
                                ...
                                $newChildren = array();
                                foreach ($children as $item) {
                                    $item['config']['elementTmpl'] = "Technodeviser_OneStepCheckout/form/element/input";
                                    $newChildren[] = $item;
                                }
                                $childs[$key]['children'] = $newChildren;
                            }
                        ...
                        if(isset($child['config']) && isset($child['config']['elementTmpl']) && $child['config']['elementTmpl'] == "ui/form/element/input"){
                            $childs[$key]['config']['elementTmpl'] = "Technodeviser_OneStepCheckout/form/element/input";
                        }
                        if(isset($child['config']) && isset($child['config']['template']) && $child['config']['template'] == "ui/form/field"){
                            $childs[$key]['config']['template'] = "Technodeviser_OneStepCheckout/form/field";
                        }
