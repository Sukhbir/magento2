 ...
 */
class Position extends \Technodeviser\OneStepCheckout\Block\Adminhtml\Widget\System\Config\ConfigAbstract
{
    /**
     * @var string
     */
    protected $_template = 'Technodeviser_OneStepCheckout::system/config/position.phtml';
