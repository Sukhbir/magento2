 ...
 */
class Style extends \Technodeviser\OneStepCheckout\Block\Adminhtml\Widget\System\Config\ConfigAbstract
{
    /**
     * @var string
     */
    protected $_template = 'Technodeviser_OneStepCheckout::system/config/style.phtml';
    ...
    {
        return $this->getViewFileUrl('Technodeviser_OneStepCheckout::images/style/' . $color . '.png');
    }
}