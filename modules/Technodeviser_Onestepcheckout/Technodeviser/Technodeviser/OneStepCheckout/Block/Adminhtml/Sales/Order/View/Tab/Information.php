...
namespace Technodeviser\OneStepCheckout\Block\Adminhtml\Sales\Order\View\Tab;

/**
 * Class Information
 * @package Technodeviser\OneStepCheckout\Block\Adminhtml\Sales\Order\View\Tab
 */
class Information extends \Magento\Backend\Block\Template implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function getDelivery()
    {
        ...
        $delivery = $this->_objectManager->create('Technodeviser\OneStepCheckout\Model\Delivery')
    ...
    {
        $orderId = $this->getOrderId();
        $survey = $this->_objectManager->create('Technodeviser\OneStepCheckout\Model\Survey')
            ->load($orderId, 'order_id');
