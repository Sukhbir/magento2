 ...
 *  
 */
namespace Technodeviser\OneStepCheckout\Helper;
use Magento\Customer\Model\AccountManagement;

/**
 * Class Config
 * @package Technodeviser\OneStepCheckout\Helper
 */
class Config extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    public function __construct(
        ...
        \Technodeviser\OneStepCheckout\Helper\DetectCountry $detectCountry,
    ...
    {
        return $this->_moduleManager->isEnabled('Technodeviser_Storepickup');
    }
    ...
    {
        return $this->_moduleManager->isEnabled('Technodeviser_Rewardpoints');
    }
    ...
    {
        return $this->_moduleManager->isEnabled('Technodeviser_Affiliateplus');
    }
