...
define(
    [
        ...
        'Technodeviser_OneStepCheckout/js/action/set-coupon-code',
        'Technodeviser_OneStepCheckout/js/action/cancel-coupon',
    ...
    function ($, ko, Component, quote, setCouponCodeAction, cancelCouponAction) {
        ...
        return Component.extend({
            defaults: {
                template: 'Technodeviser_OneStepCheckout/payment/discount'
            },
