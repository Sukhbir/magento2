...
define(
    [
        ...
        'Technodeviser_OneStepCheckout/js/action/set-shipping-information',
        'Technodeviser_OneStepCheckout/js/model/shipping-rate-service',
        'Technodeviser_OneStepCheckout/js/action/save-additional-information',
        'Magento_Ui/js/modal/alert',
        'Technodeviser_OneStepCheckout/js/view/gift-message'
    ],
    function (
        $,
        Component,
        ...
        return Component.extend({
            defaults: {
                template: 'Technodeviser_OneStepCheckout/onestepcheckout'
            },
