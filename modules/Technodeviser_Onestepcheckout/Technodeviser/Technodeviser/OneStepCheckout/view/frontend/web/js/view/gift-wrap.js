...
define(
    [
        ...
        'Technodeviser_OneStepCheckout/js/view/summary/gift-wrap',
        'Technodeviser_OneStepCheckout/js/action/reload-shipping-method',
    ...
    function($, Component, ko, storage, priceUtils, giftWrap, reloadShippingMethod, getPaymentInformation, giftWrapModel) {
        ...
        return Component.extend({
            ...
            defaults: {
                template: 'Technodeviser_OneStepCheckout/gift-wrap'
            },
