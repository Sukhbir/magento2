...
define(
    [
        ...
        'Technodeviser_OneStepCheckout/js/model/validate-shipping',
        'Technodeviser_OneStepCheckout/js/model/google-autocomplete-address'
    ],
    function (
        $,
        _,
        ...
        return Component.extend({
            defaults: {
                template: 'Technodeviser_OneStepCheckout/shipping'
            },
