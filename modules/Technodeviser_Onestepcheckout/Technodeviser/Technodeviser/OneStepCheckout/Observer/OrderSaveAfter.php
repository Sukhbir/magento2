...
{
    /**
     * @var \Technodeviser\OneStepCheckout\Model\DeliveryFactory
     */
     ...
     * @param \Technodeviser\OneStepCheckout\Model\DeliveryFactory $deliveryFactory
     * @param \Psr\Log\LoggerInterface $logger
     * @param \Magento\Checkout\Model\Session $checkoutSession
     * @param array $data
     */
    public function __construct(
        \Technodeviser\OneStepCheckout\Model\DeliveryFactory $deliveryFactory,
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($deliveryDate) {
            if ($orderId && $deliveryDate) {
                /** @var \Technodeviser\OneStepCheckout\Model\Delivery $delivery */
