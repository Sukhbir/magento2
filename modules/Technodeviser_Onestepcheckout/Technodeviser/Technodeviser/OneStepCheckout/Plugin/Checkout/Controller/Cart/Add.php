...
namespace Technodeviser\OneStepCheckout\Plugin\Checkout\Controller\Cart;
use Magento\Framework\Controller\ResultFactory;
/**
 * Class Image
 * @package Technodeviser\OneStepCheckout\Plugin
 */
class Add extends \Magento\Checkout\Controller\Cart\Add
{
    ...
    {
        return $this->_objectManager->get('Technodeviser\OneStepCheckout\Helper\Config')->isEnabledOneStep() &&
        $this->_objectManager->get('Technodeviser\OneStepCheckout\Helper\Config')->allowRedirectCheckoutAfterAddProduct();
    }
