...
namespace Technodeviser\OneStepCheckout\Plugin\Checkout\Controller\Index;

/**
 * Class Index
 * @package Technodeviser\OneStepCheckout\Plugin\Checkout\Controller\Index
 */
class Index extends \Magento\Checkout\Controller\Index\Index
{
    ...
    {
        if ($this->_objectManager->get('Technodeviser\OneStepCheckout\Helper\Config')->isEnabledOneStep()) {
