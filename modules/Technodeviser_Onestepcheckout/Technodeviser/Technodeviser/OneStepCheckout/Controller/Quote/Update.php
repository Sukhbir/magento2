...
namespace Technodeviser\OneStepCheckout\Controller\Quote;
/**
 * Class Update
 * @package Technodeviser\OneStepCheckout\Controller\Quote
 */
class Update extends \Magento\Framework\App\Action\Action {
     ...
     * @param \Technodeviser\OneStepCheckout\Helper\Data $oscHelper
    ...
    public function __construct(
        ...
        \Technodeviser\OneStepCheckout\Helper\Data $oscHelper,
    ...
    public function execute()
    {
        ...
        if ($this->_configHelper->hasRewardPoints()) {
            $rewardData = $this->_objectManager->get('Technodeviser\Rewardpoints\Block\Checkout\Form')->getRewardpointsData();
            $knockoutData = $this->_objectManager->get('Technodeviser\Rewardpoints\Block\Checkout\Cart\Point')
                ->knockoutData();
        ...
        if ($this->_configHelper->hasAffiliate()) {
            $affiliateData = $this->_objectManager->get('Technodeviser\Affiliateplus\Block\Affiliateplus\Form')->getAffiliateplusData();
