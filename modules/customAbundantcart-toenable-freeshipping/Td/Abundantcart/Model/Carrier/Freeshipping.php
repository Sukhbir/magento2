 ...
 */
namespace Td\Abundantcart\Model\Carrier;
    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        // $allcoupons = array();
        // $couponlist = $this->ObjectManager->create('Magento\SalesRule\Model\Coupon')->getCollection()->addFieldToFilter('rule_id', array('eq' => 21)); 
        // foreach($couponlist as $coupondata)
        // {
            // $allcoupons[] = $coupondata['code'];
        // }
        // if(in_array($couponcode,$allcoupons))
		if(($couponcode != null) && ($quote->getSubtotal() < 500) &&($customerSession->getCoupon() == $couponcode))
        {
