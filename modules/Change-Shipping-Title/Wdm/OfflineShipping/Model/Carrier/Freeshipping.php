 ...
 */
namespace Wdm\OfflineShipping\Model\Carrier;
    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    /**
     * @var \Wdm\OfflineShipping\Helper\Data
     */
    protected $_helper;
    ...
    public function __construct(
        ...
        \Wdm\OfflineShipping\Helper\Data $_helper,
        array $data = []
    ) {
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        if ($request->getFreeShipping() || $request->getBaseSubtotalInclTax() >= $this->getConfigData(
            ...
            $method->setCarrierTitle($this->helper->ShippingTitle());

            $method->setMethod('freeshipping');
            $method->setMethodTitle($this->helper->ShippingTitle());
